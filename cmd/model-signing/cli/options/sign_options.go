...
type Pkcs11SignOptions struct {
	ModelPathFlags
	SignatureOutputFlags
	// Pkcs11URI provides the PKCS#11 URI identifying the key and module.
	Pkcs11URI string
...
func (o *Pkcs11SignOptions) AddFlags(cmd *cobra.Command) {
	...
	cmd.Flags().StringVar(&o.Pkcs11URI, "pkcs11-uri", "", "PKCS#11 URI identifying the key. Format: pkcs11:token=TOKEN;object=KEY?module-name=MODULE&pin-value=PIN [required]")
