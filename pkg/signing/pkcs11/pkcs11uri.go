...
func (p *Pkcs11URI) Parse(uri string) error {
...
func (p *Pkcs11URI) validate() error {
	// Validate slot-id
...
func (p *Pkcs11URI) GetPIN() (string, error) {
...
func (p *Pkcs11URI) GetModule() (string, error) {
...
func (p *Pkcs11URI) isAllowedPath(path string) bool {
	if p.allowAnyModule {
		return true
	}
...
func (p *Pkcs11URI) GetKeyIDAndLabel() ([]byte, string, error) {
	var keyID []byte
	var label string
...
func (p *Pkcs11URI) GetSlotID() (int, error) {
...
func (p *Pkcs11URI) GetTokenLabel() string {
